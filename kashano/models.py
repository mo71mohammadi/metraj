...
class Estate(models.Model):
    ...
    fitfor = models.CharField(max_length=300, null=True, blank=True)
    fitfor_other = models.CharField(max_length=300, null=True, blank=True)
    ...
    edited_fields = models.CharField(max_length=300, null=True, blank=True)
